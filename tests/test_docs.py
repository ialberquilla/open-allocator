...
REVIEW_FOCUS_CHECKS = {
    ...
    "measured_diversification": ("open_allocator.core.diversify", "report"),
    "metric_coverage": ("open_allocator.core.diversify", "report"),
    ...
    "strategy_choice": ("open_allocator.core.strategies.library", "desired_weights"),
